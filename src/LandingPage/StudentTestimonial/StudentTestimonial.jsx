  ...
  return (
    <div id='testimonials' className="w-full mt-[200px]">
      <div className=" w-fit relative mb-20 md:mb-[200px]  max-w-[560px] md:px-[100px] px-5">
        <h1 className="text-white text-4xl sm:text-5xl md:text-[64px]   font-black relative z-10 uppercase">
          Student Testimonials
        </h1>
        <span className="sm:h-[28px] h-5 w-[260px] sm:w-[350px] md:w-[430px] bg-[#8EC8EE] block absolute md:bottom-2 bottom-1 md:left-[115px] left-8"></span>
      </div>

      <Marquee speed={40} gradient={false}>
        {testimonials.map((item, idx) => (
          <div key={idx} className="relative w-fit mr-10 ">
            <img className="  h-72 md:object-cover md:h-[330px] lg:h-full " src={item.img} alt="" />
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
              <h1 className="text-white text-base md:text-xl lg:text-5xl font-black max-w-[378px]">
                {item.quote}
              </h1>
              <p className="text-white font-normal text-xs  lg:text-xl my-5">{item.meta}</p>
              ...
              <div className="flex gap-[10px]">
                ...
                <svg 
  viewBox="0 0 24 24" 
  className="w-2 h-2 sm:w-4 sm:h-4 md:w-4 md:h-4 lg:w-6 lg:h-6"
  fill="none"
>
  <path
    d="M15 2C13.67 2 12.4 2.53 11.46 3.46C10.53 4.4 10 5.67 10 7V10H7V14H10V22H14V14H17L18 10H14V7C14 6.73 14.11 6.48 14.29 6.29C14.48 6.1 14.73 6 15 6H18V2H15Z"
  ...
  />
                ...
                {/* instagram */}
                <svg viewBox="0 0 24 24" className="w-2 h-2 sm:w-4 sm:h-4 md:w-4 md:h-4 lg:w-6 lg:h-6" fill="none">
                  <path
